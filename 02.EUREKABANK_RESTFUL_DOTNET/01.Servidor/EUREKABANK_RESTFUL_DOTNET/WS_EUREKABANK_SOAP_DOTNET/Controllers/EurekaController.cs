...
using WS_EUREKABANK_SOAP_DOTNET.Models;

namespace WS_EUREKABANK_SOAP_DOTNET.Controllers
{
    public class EurekaController : Controller
    {
        private readonly eurekabankEntities _context = new eurekabankEntities();
